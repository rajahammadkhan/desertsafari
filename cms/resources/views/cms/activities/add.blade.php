        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">All Activities</li>
                    <li class="breadcrumb-item"><a href="{{route('activities')}}">Activities</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('activitie.update', [$activity->id]) : route('activitie.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                        <input type="hidden" name="_method" value="put">
                        <input type="hidden" name="id" value="{{ $activity->id ?? null }}">
                    @endif
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Activities / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>

                            <div class="col-md-6 text-right">
                                <a href="{{route('activities')}}" class="btn btn-danger"> 
                    ...
                    <div class="form-row mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input {{!$isEdit ? 'required' : null}} type="file" name="featured_image"  class="file" accept="image/*" value="{{ $activity->featured_image ?? null }}">
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$activity->featured_image ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('image'))
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="">Activity Type <span class="text-danger"> * </span></label>
                                        @if($isEdit)
                                        <select class="basic" name="type" required>
                                            <option selected disabled>Please Select</option>
                                                <option {{$isEdit && $activity->activity_type == 'Best Selling Activities - Dubai' ? 'selected' : null}} value="Best Selling Activities - Dubai">Best Selling Activities - Dubai</option>
                                                <option {{$isEdit && $activity->activity_type == 'Adventure Tours & Activities' ? 'selected' : null}} value="Adventure Tours & Activities">Adventure Tours & Activities</option>
                                        </select>
                                        @else
                                        <select class="basic" name="type" required>
                                            <option selected disabled>Please Select</option>
                                                <option value="Best Selling Activities - Dubai">Best Selling Activities - Dubai</option>
                                                <option value="Adventure Tours & Activities">Adventure Tours & Activities</option>
                                        </select>
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="name" value="{{ $activity->name ?? old('name') ?? null }}"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="price" value="{{ $activity->price ?? old('price') ?? null }}"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="operating_hours" value="{{ $activity->operating_hours ?? old('operating_hours') ?? null }}"
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="instant_confirmation" value="{{ $activity->instant_confirmation ?? old('instant_confirmation') ?? null }}"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="mobile_voucher_accepted" value="{{ $activity->mobile_voucher_accepted ?? old('mobile_voucher_accepted') ?? null }}"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="non_refundable" value="{{ $activity->non_refundable ?? old('non_refundable') ?? null }}"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="language" value="{{ $activity->language ?? old('language') ?? null }}"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select class="basic" name="country_state" required>
                                            <option selected disabled>Please Select</option>
                                                <option {{$isEdit && $activity->country_state == 'Abu Dhabi' ? 'selected' : null}} value="Abu Dhabi">Abu Dhabi</option>
                                                <option {{$isEdit && $activity->country_state == 'Ajman' ? 'selected' : null}} value="Ajman">Ajman</option>
                                                <option {{$isEdit && $activity->country_state == 'Al Ain' ? 'selected' : null}} value="Al Ain">Al Ain</option>
                                                <option {{$isEdit && $activity->country_state == 'Dubai' ? 'selected' : null}} value="Dubai">Dubai</option>
                                                <option {{$isEdit && $activity->country_state == 'Fujairah' ? 'selected' : null}} value="Fujairah">Fujairah</option>
                                                <option {{$isEdit && $activity->country_state == 'Ras Al-Khaimah' ? 'selected' : null}} value="Ras Al-Khaimah">Ras Al-Khaimah</option>
                                                <option {{$isEdit && $activity->country_state == 'Sharjah' ? 'selected' : null}} value="Sharjah">Sharjah</option>
                                        </select>
                                        @else
                                        <select class="basic" name="country_state" required>
                                            <option selected disabled>Please Select</option>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="transfer_options_available" value="{{ $activity->transfer_options_available ?? old('transfer_options_available') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="google_map_link" value="{{ $activity->google_map_link ?? old('google_map_link') ?? null }}"
                            ...
                            <div class="form-group col-md-11 mt10">    
                                <h5><b>Activity Price & Options</b></h5>
                            </div>
                                                ...
                                                @foreach($activity->features as $key => $feature)
                                                    <div class="row addmore_cont1 ml30">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label for="">Activity Date <span class="text-danger"> * </span></label>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea cols="200" class="summernote" name="about_experience">{!! $activity->about_experience ?? null !!}</textarea>
                            </div> 

                            <div class="col-md-12 mt-4">
                                <label>Highlights</label>
                                <textarea cols="200" class="summernote" name="highlights">{!! $activity->highlights ?? null !!}</textarea>
                            </div>

                            <div class="col-md-12 mt-4">
                                <label>Tour Inclusions</label>
                                <textarea cols="200" class="summernote" name="tour_inclusions">{!! $activity->tour_inclusions ?? null !!}</textarea>
                            </div>

                            <div class="col-md-12 mt-4">
                                <label>Important Information</label>
                                <textarea cols="200" class="summernote" name="important_information">{!! $activity->important_information ?? null !!}</textarea>
                            </div> 

                            <div class="col-md-12 mt-4">
                                <label>Booking Policy</label>
                                <textarea cols="200" class="summernote" name="booking_policy">{!! $activity->booking_policy ?? null !!}</textarea>
                            </div> 
                            ...
                            <div class="col-md-12 mt30">
                                <div class="custom-file-container" data-upload-id="galleryImages">
                                    ...
                                    <br>
                                     @foreach($activity->images as $key => $feature)
        ...
        $(document).ready(function() {
            ...
            $('.imagedelete').click(function () {
              ...
              swal({
                ...
                if (result.value) {
                axios
                  .post('{{route("activityimage.destroy")}}', {
                    _method: 'delete',
                    _token: '{{csrf_token()}}',
                    deleteId: deleteId,
                  })
            ...
            $('.remove').click(function () {
              ...
              swal({
                ...
                if (result.value) {
                axios
                  .post('{{route("activityfeature.destroy")}}', {
                    _method: 'delete',
                    _token: '{{csrf_token()}}',
