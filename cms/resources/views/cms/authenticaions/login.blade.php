...
<title>Login | Desert Safari</title>
  ...
  <div id="main" class="main-container">
    <div class="box">
      <div class="row mb-5 ml-1">
        <img src="{{url('')}}/assets/images/logo.png" style="margin: auto; width: 330px;">
      ...
      <p class="text-center mt-4"> Copyright © 2023 | <a href="https://desertsafari4x4.com" >Desert Safari</a></p>
    </div>
    </div>
  </div>
</div>
