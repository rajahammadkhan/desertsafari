                        ...
                        <div style="background: rgba(0, 0, 0, 0.8);">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">Discount Coupon</h5>
                                </div>
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('discount.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add</a>
                                    </div>
                            </div>
                        </div>
                        <br>
...
@include('cms.discount_coupon.includes.discount_coupon-js')
@endsection
