                            ...
                            <div class="row">
                                ...
                                @can('Listings-add')
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('product.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add product</a>
                                    </div>
                                @endcan
                            </div>
                        </div>
                        ...
                        <table id="datatable" class="table table-bordered table-hover table-condensed mb-4" width="100%" cellspacing="0"
                            ...
                            <thead class="datatable">
                                <tr>
                                    ...
                                    <th class="no-sort text-center" width="5%">Published</th>
                                    <th class="no-sort text-center" width="8%">Best Selling</th>
                                    <th class="no-sort text-center" width="5%">Polular</th>
                                    <th class="no-sort text-center" width="8%">New Arrival</th>
...
@include('cms.products.includes.products-js')
@endsection
