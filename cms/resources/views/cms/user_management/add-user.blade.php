        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('user')}}">Admin</a></li>
                    ...
                    <div style="background: rgba(0, 0, 0, 0.8);">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Admin / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>
                            ...
                            <div class="form-row col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="email" value="{{ $isEdit ? $user->email : null }}"
                                        class="form-control" placeholder="Enter Email..." required readonly>
                                    @if ($errors->has('email'))
