        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">All Tours</li>
                    <li class="breadcrumb-item"><a href="{{route('tours')}}">Tours</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('tour.update', [$tour->id]) : route('tour.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                        <input type="hidden" name="_method" value="put">
                        <input type="hidden" name="id" value="{{ $tour->id ?? null }}">
                    @endif
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Tours / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>

                            <div class="col-md-6 text-right">
                                <a href="{{route('tours')}}" class="btn btn-danger"> 
                    ...
                    <div class="form-row mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input {{!$isEdit ? 'required' : null}} type="file" name="featured_image"  class="file" accept="image/*" value="{{ $tour->featured_image ?? null }}">
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$tour->featured_image ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('image'))
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="">Tours Type <span class="text-danger"> * </span></label>
                                        @if($isEdit)
                                        <select class="basic" name="type" required>
                                            <option selected disabled>Please Select</option>
                                                <option {{$isEdit && $tour->activity_type == 'Tours' ? 'selected' : null}} value="Tours">Tours</option>
                                                <option {{$isEdit && $tour->activity_type == 'Best Saver Combo Tours' ? 'selected' : null}} value="Best Saver Combo Tours">Best Saver Combo Tours</option>
                                        </select>
                                        @else
                                        <select class="basic" name="type" required>
                                            <option selected disabled>Please Select</option>
                                                <option value="Tours">Tours</option>
                                                <option value="Best Saver Combo Tours">Best Saver Combo Tours</option>
                                        </select>
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="name" value="{{ $tour->name ?? old('name') ?? null }}"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="price" value="{{ $tour->price ?? old('price') ?? null }}"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="operating_hours" value="{{ $tour->operating_hours ?? old('operating_hours') ?? null }}"
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="instant_confirmation" value="{{ $tour->instant_confirmation ?? old('instant_confirmation') ?? null }}"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="mobile_voucher_accepted" value="{{ $tour->mobile_voucher_accepted ?? old('mobile_voucher_accepted') ?? null }}"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="non_refundable" value="{{ $tour->non_refundable ?? old('non_refundable') ?? null }}"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="language" value="{{ $tour->language ?? old('language') ?? null }}"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select class="basic" name="country_state" required>
                                            <option selected disabled>Please Select</option>
                                                <option {{$isEdit && $tour->country_state == 'Abu Dhabi' ? 'selected' : null}} value="Abu Dhabi">Abu Dhabi</option>
                                                <option {{$isEdit && $tour->country_state == 'Ajman' ? 'selected' : null}} value="Ajman">Ajman</option>
                                                <option {{$isEdit && $tour->country_state == 'Al Ain' ? 'selected' : null}} value="Al Ain">Al Ain</option>
                                                <option {{$isEdit && $tour->country_state == 'Dubai' ? 'selected' : null}} value="Dubai">Dubai</option>
                                                <option {{$isEdit && $tour->country_state == 'Fujairah' ? 'selected' : null}} value="Fujairah">Fujairah</option>
                                                <option {{$isEdit && $tour->country_state == 'Ras Al-Khaimah' ? 'selected' : null}} value="Ras Al-Khaimah">Ras Al-Khaimah</option>
                                                <option {{$isEdit && $tour->country_state == 'Sharjah' ? 'selected' : null}} value="Sharjah">Sharjah</option>
                                        </select>
                                        @else
                                        <select class="basic" name="country_state" required>
                                            <option selected disabled>Please Select</option>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="transfer_options_available" value="{{ $tour->transfer_options_available ?? old('transfer_options_available') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="google_map_link" value="{{ $tour->google_map_link ?? old('google_map_link') ?? null }}"
                                                ...
                                                @foreach($tour->features as $key => $feature)
                                                    ...
                                                    <div class="row addmore_cont1 ml30">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label for="">Tour Date <span class="text-danger"> * </span></label>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea cols="200" class="summernote" name="about_experience">{!! $tour->about_experience ?? null !!}</textarea>
                            </div> 

                            <div class="col-md-12 mt-4">
                                <label>Highlights</label>
                                <textarea cols="200" class="summernote" name="highlights">{!! $tour->highlights ?? null !!}</textarea>
                            </div>

                            <div class="col-md-12 mt-4">
                                <label>Tour Inclusions</label>
                                <textarea cols="200" class="summernote" name="tour_inclusions">{!! $tour->tour_inclusions ?? null !!}</textarea>
                            </div>

                            <div class="col-md-12 mt-4">
                                <label>Important Information</label>
                                <textarea cols="200" class="summernote" name="important_information">{!! $tour->important_information ?? null !!}</textarea>
                            </div> 

                            <div class="col-md-12 mt-4">
                                <label>Booking Policy</label>
                                <textarea cols="200" class="summernote" name="booking_policy">{!! $tour->booking_policy ?? null !!}</textarea>
                            </div> 
                            ...
                            <div class="col-md-12 mt30">
                                <div class="custom-file-container" data-upload-id="galleryImages">
                                    ...
                                    <br>
                                     @foreach($tour->images as $key => $feature)
        ...
        $(document).ready(function() {
            ...
            $('.remove').click(function () {
              ...
              swal({
                ...
                if (result.value) {
                axios
                  .post('{{route("tourfeature.destroy")}}', {
                    _method: 'delete',
                    _token: '{{csrf_token()}}',
