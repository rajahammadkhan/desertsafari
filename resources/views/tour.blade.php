...
@section('content') 
    <main class="main">
        <div class="page-header text-center" style="background-image: url('{{url('')}}/assets/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">Desert Safari 4x4<span>Tours</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
                        ...
                        <div class="toolbox">
                            <div class="toolbox-left">
                                <div class="toolbox-info">
                                    Showing <span>{{$tours_count}}</span> Tours
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-lg-3">
                                            <figure class="product-media">
                                                ...
                                                <a href="{{route('get_activity',$tour->slug)}}">
                                                    <img src="{{config('fashion.file_path').$tour->featured_image}}" alt="{{$tour->name}}" class="product-image">
                                                </a>
                                        ...
                                        <div class="col-6 col-lg-2 order-lg-last">
                                            <div class="product-list-action">
                                                <div class="product-price">
                                                     <span id="amount">{{number_format($tour->price)}}.00</span> 
                                                     <span id="amount_code"> AED</span>
                                                </div><!-- End .product-price -->

                                                <a href="{{route('get_activity',$tour->slug)}}" class="btn-product btn-cart" style="border-color: #001433;"><span>add to cart</span></a>
                                            </div><!-- End .product-list-action -->
                                        </div><!-- End .col-sm-6 col-lg-3 -->

                                        <div class="col-lg-7">
                                            <div class="product-body product-action-inner">
                                                <add-to-wishlist-button product-id="{{ $tour->id }}" :user-id="{{ Auth::user()->id ?? 0 }}"></add-to-wishlist-button>
                                                <div class="product-cat">
                                                    <a href="javascript::void()">{{$tour->activity_type}}</a>
                                                </div><!-- End .product-cat -->
                                                <h3 class="product-title"><a href="{{route('get_activity',$tour->slug)}}">{{$tour->name}}</a></h3><!-- End .product-title -->

                                                <div class="product-content">
                                                    <p>{!! $tour->about_experience !!}</p>
