...
<!-- Required meta tags -->
    <meta charset="utf-8">
    <title>500 Error | Desert Safari</title>
...
<body>
    ...
    <main class="main">
        <div class="error-content text-center" style="background-image: url('{{url('')}}/assets/images/backgrounds/error-bg.jpg')">
            <div class="container">
                <h1 class="error-title">Opps ! We,ar Not Found This Page</h1><!-- End .error-title -->
